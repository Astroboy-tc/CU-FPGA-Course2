...
// 
*/
module find_errors(a,b,c);                           // line 1 - error
  input  [0:3]a;                             // line 2 - error
  output [3:0]b;                             // line 3
  input [5:0]c;                               // line 4 - error
                                             // line 5
  wire [0:3]aw;                              // line 6
  reg [3:0]bw;                              // line 7 - error
  reg [5:0]creg;                              // line 8 - error
begin                                        // line 9
  assign aw = a;                             // line 10
  assign b = bw;                             // line 11
  assign c = creg;                           // line 12 - error
always@(creg)                                    // line 13 - error
  begin                                      // line 14
    if (creg == 6'b 111111)   //creg is all 1s     // line 15 - error
       bw <= aw;                             // line 16  
    else                                     // line 17
     bw <= 4'b0101;                           // line 18 - error  
    end;                                     // line 19
  end                              // line 20  - error
endmodule                                          // line 21  - error
